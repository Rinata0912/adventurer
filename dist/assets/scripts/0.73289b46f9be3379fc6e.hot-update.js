...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
		...
		function accordion() {
			(0, _jquery2.default)('.accordion__header').on('click', function () {
				if ((0, _jquery2.default)(this).parent().hasClass('accordion_state_open')) {
					(0, _jquery2.default)(this).parent().find('.accordion__text').slideDown();
					(0, _jquery2.default)(this).parent().removeClass('accordion_state_open');
				} else {
					(0, _jquery2.default)(this).parent().find('.accordion__text').slideUp();
					(0, _jquery2.default)(this).parent().addClass('accordion_state_open');
				}
			});
		}
		accordion();
...
//# sourceMappingURL=0.73289b46f9be3379fc6e.hot-update.js.map